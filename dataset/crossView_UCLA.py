...
class NUCLA_CrossView(Dataset):
    ...
    def __init__(self, root_list, dataType, sampling, phase, cam, T, maskType, setup):
    ...
    def paddingSeq(self, skeleton, normSkeleton, imageSequence, ROIs, visibility, affineSkeleton):
        ...
        return skeleton_New, normSkeleton_New, imageSequence_New, ROIs_New, visibility_New,affineSkeleton_new
    ...
    def get_data(self, view, name_sample):
        ...
        if self.T == 0:
            ...
            if skeleton_input.shape[0] != self.T:
                skeleton_input, normSkeleton_input, imageSequence_input, ROIs_input, visibility_input, affineSkeletons_input \
                    = self.paddingSeq(skeleton_input,normSkeleton_input, imageSequence_input, ROIs_input, visibility_input, affineSkeletons_input)
    ...
    def __getitem__(self, index):
        ...
        if self.sampling == 'Single':
            heat_maps, images, skeletons, rois = self.get_data(view, name_sample)
...
if __name__ == "__main__":
    ...
    trainSet = NUCLA_CrossView(root_list=path_list, dataType='2D', sampling='Single', phase='train', cam='2,1,3', T=36,maskType='score',
                               setup=setup)
