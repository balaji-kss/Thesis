...
class FISTAProblem:
    def __init__(
        ...
        self.smooth_loss = smooth_loss  # coeff loss
        self.smooth_grad = smooth_grad  # coeff grad

        self.proximable_loss = proximable_loss  # l1 l2 term regularization
        self.prox = prox # l1, l2 proximal
